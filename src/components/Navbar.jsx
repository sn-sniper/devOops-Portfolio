    ...
    return (
        <div className='relative w-screen Navbar-container'>
            ...
            <div className='flex items-center justify-between w-full nav-content'>
                ...
                <Btnt bg={false} text="get in touch" border={true} className="hidden md:block" />
            </div>
            ...
            <div className={`fixed top-0 right-0 h-full bg-white shadow-lg transition-all duration-300 ease-in-out ${menuOpen ? 'w-64' : 'w-0'} overflow-hidden z-50`}>
                <div className="flex items-center justify-between p-5 border-b">
                    <h2 className="text-xl font-bold">Menu</h2>
                    <button onClick={toggleMenu} className="p-2 text-gray-700 hover:text-gray-900">
                        <HiX size={28} />
                    </button>
                </div>
                <ul className='flex flex-col p-5 space-y-4'>
                    <li className='nav-item hover:text-indigo-500' data-title="Home"><span>Home</span></li>
                    <li className='nav-item hover:text-indigo-500' data-title="About"><span>About</span></li>
                    <li className='nav-item hover:text-indigo-500' data-title="Services"><span>Services</span></li>
                    <li className='nav-item hover:text-indigo-500' data-title="Contact"><span>Contact</span></li>
                </ul>
            </div>
        </div>
    );
